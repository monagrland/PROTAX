...
sub createX {
    ...
    my ($i,$cnode,$max,$eml,$wref, $nok, $nmissing, $p);
...
if (scalar(@ARGV) < 11) {
    die "usage: trainclassify5sa.pl unkprior seqidnseq_file(nodeinfo,qseq,start probs) taxonomyfile seqid2taxonomy_file taxonomy2rseqid_file params_file params_mode seqsimfile max_out_num(0 for all) prob_th outfile debug_mode\n";
}
